...
**Solution**
```sql
SELECT DISTINCT(CITY) FROM STATION WHERE UPPER(SUBSTR(city,1,1)) IN ('A','I','U','E','O');       
```
...
**Solution**
```sql
SELECT DISTINCT(CITY) FROM STATION WHERE LOWER(SUBSTR(city,LENGTH(city),LENGTH(city))) IN ('a','i','u','e','o');       
```
...
**Solution**
```sql
SELECT DISTINCT CITY FROM STATION WHERE UPPER(SUBSTR(city,1,1)) IN ('A','I','U','E','O') AND LOWER(SUBSTR(city,LENGTH(city),LENGTH(city))) IN ('a','i','u','e','o');      
```
...
**Solution**
```sql
SELECT DISTINCT CITY FROM STATION WHERE UPPER(SUBSTR(CITY, 1, 1)) NOT IN ('A','E','I','O','U') AND LOWER(SUBSTR(CITY, LENGTH(CITY),LENGTH(city))) NOT IN ('a','e','i','o','u');    
```
...
**Solution**
```sql
SELECT DISTINCT CITY FROM STATION WHERE LOWER(SUBSTR(CITY,1,1)) NOT IN ('a','e','i','o','u') AND LOWER(SUBSTR(CITY,LENGTH(CITY),LENGTH(city))) NOT IN ('a','e','i','o','u');    
```
